...
test_soap_service "CustomerService" "http://localhost:7001/soap" "urn:soa-ecommerce:v1:customers/ICustomerService/CreateCustomer" "$create_customer_envelope"
...
test_soap_service "CatalogService" "http://localhost:7002/soap" "urn:soa-ecommerce:v1:catalog/ICatalogService/CreateProduct" "$create_product_envelope"
...
test_soap_service "CompositionService" "http://localhost:7000/soap" "urn:soa-ecommerce:v1:process/ICompositionService/PlaceOrder" "$place_order_envelope"
